...
from notifications.services.SMSService import SMSService
from notifications.providers.SWVLSMSProvider import SWVLSMSProvider
...
class SMSNotification(Notification):
    def __init__(self):
        self.service = SMSService(SWVLSMSProvider())
